...
function custom_dashboard_widget_content() {
  ?>
    ...
    <p>Use the quicklinks below to add and manage your website content.</p>
    <ul class="custom-db__buttons">
      <li><a class="custom-db__button" href="<?php echo admin_url('post-new.php?post_type=page') ?>">Add a New Page</a></li>
      <li><a class="custom-db__button" href="<?php echo admin_url('edit.php?post_type=page') ?>">Manage Pages</a></li>
    </ul>
  <?php
}
