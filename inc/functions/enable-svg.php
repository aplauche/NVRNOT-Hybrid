 ...
 * @return array
 */
function nvrnot_add_mime_types( $mimes ) {
	$mimes['svg'] = 'image/svg+xml';
	return $mimes;
}
add_filter( 'upload_mimes', __NAMESPACE__ . '\nvrnot_add_mime_types' );
 ...
 * @return array
 */
function nvrnot_check_filetype( $data, $file, $filename, $mimes ) {
...
add_filter( 'wp_check_filetype_and_ext', __NAMESPACE__ . '\nvrnot_check_filetype', 10, 4 );
