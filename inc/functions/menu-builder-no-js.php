 ...
 * no JS navigation menus without needing a custom walker
 * 
 * USAGE: nvrnot\menuBuilderNoJs\render_menu($menu_name)
 * 
...
namespace nvrnot\menuBuilderNoJs;
